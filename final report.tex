...
Figure \ref{fig:FIDEPE} shows a simple example of the quantities above described. Here local density is marked as numbers above each of the points, the circles around them define a neighborhood of radius $d_c$ and the directed arrows.
